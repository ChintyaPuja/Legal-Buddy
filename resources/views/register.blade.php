            ...
            <div class="row justify-content-center">
              <div class="col-lg-7">
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  <div class="card-header justify-content-center" style="background-color:#F07D00">
                    <h3 class="font-weight-light my-4" style="color: #ffff ; text-align: center">Create Account</h3>
                  </div>
                  <div class="card-body">
                    <!-- Registration form-->
                    <form method="POST" action="/registeruser">
                      ...
                      <div class="form-group mt-4 mb-0">
                        <input class="nav-link btn btn-warning" type="submit" value="Create Account">
                      </div>
                    </form>
                  </div>
                  <div class="card-footer text-center">
                    <div class="small">
                      <a href="/login" style="color:gray">Have an account? Go to login</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div id="layoutAuthentication_footer">
        <footer class="footer mt-auto footer-dark">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 small">Copyright &#xA9; Legal Buddy</div>
