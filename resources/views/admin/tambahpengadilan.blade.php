...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        ...
        <form method="post" action="/admin2-tambahpengadilan-insert" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
              <label for="nama_pengadilan" class="form-label">Nama Pengadilan</label>
              <input type="text" class="form-control" id="nama_pengadilan" name="nama_pengadilan">              
            </div>
            <div class="mb-3">
