...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <h1>Data Firma</h1>
        <form method="post" action="/admin-firmaupdate/{{ $data->id }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
              <label for="nama_firma" class="form-label">Nama Firma</label>
              <input type="text" class="form-control" id="nama_firma" value="{{ $data->nama_firma }}" name="nama_firma">              
            </div>
            <div class="mb-3">
              ...
              <img src="{{ asset('gambarfirma/'.$data->gambar ) }}" height="100" width="100" class="rounded-circle d-block mx-auto" alt="...">
